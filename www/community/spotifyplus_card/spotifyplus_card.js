...
`;const qi=new class{constructor(){this._propValues={}}addPropertyValue(e){if(!this._propValues.hasOwnProperty(e)){const t=window.localStorage.getItem(e);this._propValues[e]=t?JSON.parse(t):null}}getPropertyValue(e){return this._propValues[e]}setPropertyValue(e,t){this._propValues[e]=t}saveProperties(){for(const e in this._propValues)this._propValues.hasOwnProperty(e)&&window.localStorage.setItem(e,JSON.stringify(this._propValues[e]))}saveProperty(e){this._propValues.hasOwnProperty(e)&&window.localStorage.setItem(e,JSON.stringify(this._propValues[e]))}getStorageValue(e,t=null){const i=window.localStorage.getItem(e);return i?JSON.parse(i):t}setStorageValue(e,t){window.localStorage.setItem(e,JSON.stringify(t))}clearStorageValue(e){window.localStorage.removeItem(e)}clearStorage(){window.localStorage.clear();for(const e in this._propValues)this._propValues.hasOwnProperty(e)&&(this._propValues[e]=null)}clearStorageByKey(e){this._propValues.hasOwnProperty(e)&&(window.localStorage.removeItem(e),this._propValues[e]=null)}},Gi=Pe(de+":fav-browser-base"),Ji="_filtercriteria",Wi="_medialist",Yi="_medialistlastupdated",zi="Previous refresh is still in progress - please wait";class ji extends ri{constructor(e){super(),this.EDITOR_LIMIT_TOTAL_MAX=25,this.LIMIT_TOTAL_MAX=200,this.isActionsEnabled=!0,this.isMediaListRefreshedOnSectionEntry=!1,this.mediaType=e,this.shuffleOnPlay=!1,this.onKeyDown_EventListenerBound=this.onKeyDown.bind(this)}render(){Gi.enabled&&Gi("render - rendering control: %s\n- mediaListLastUpdatedOn = %s\n- scrollTopSaved = %s\n- filterItemCount = %s (pre-render)",JSON.stringify(this.mediaType),JSON.stringify(this.mediaListLastUpdatedOn),JSON.stringify(this.scrollTopSaved),JSON.stringify(this.filterItemCount)),this.hass=this.store.hass,this.config=this.store.config,this.player=this.store.player,this.spotifyPlusService=this.store.spotifyPlusService,this.isCardInEditPreview=ht(this.store.card),this.setScrollPosition(),this.isFilterCriteriaReadOnly=!1,this.isFilterCriteriaVisible=!0,this.filterCriteriaHtml=H`
    ...
    `]}async onClickAction(e){try{return!this.isCardInEditPreview&&(e==ks.AlbumCopyPresetToClipboard?(it(Ei(this.track?.album,this.track?.album.artists[0].name)),this.alertInfoSet(be),!0):e==ks.AlbumCopyPresetJsonToClipboard?(it(_i(this.track?.album,this.track?.album.artists[0].name)),this.alertInfoSet(Ce),!0):e==ks.AlbumCopyUriToClipboard?(it(this.track?.album.uri||""),!0):e==ks.AlbumSearchRadio?(this.dispatchEvent(di(Tt.PLAYLISTS,this.track?.album.name+ve+this.track?.artists[0].name)),!0):e==ks.AlbumShowTracks?(this.dispatchEvent(di(Tt.ALBUM_TRACKS,this.track?.album.name+"; "+this.track?.artists[0].name,this.track?.album.name,this.track?.album.uri,null,this.track?.album)),!0):e==ks.ArtistCopyPresetToClipboard?(it(Ei(this.track?.artists[0])),this.alertInfoSet(be),!0):e==ks.ArtistCopyPresetJsonToClipboard?(it(_i(this.track?.artists[0])),this.alertInfoSet(Ce),!0):e==ks.ArtistCopyUriToClipboard?(it(this.track?.artists[0].uri||""),!0):e==ks.ArtistSearchPlaylists?(this.dispatchEvent(di(Tt.PLAYLISTS,this.track?.artists[0].name)),!0):e==ks.ArtistSearchRadio?(this.dispatchEvent(di(Tt.PLAYLISTS,this.track?.artists[0].name+ve)),!0):e==ks.ArtistSearchTracks?(this.dispatchEvent(di(Tt.TRACKS,this.track?.artists[0].name)),!0):e==ks.ArtistShowAlbums?(this.dispatchEvent(di(Tt.ARTIST_ALBUMS,this.track?.artists[0].name,this.track?.artists[0].name,this.track?.artists[0].uri)),!0):e==ks.ArtistShowAlbumsAppearsOn?(this.dispatchEvent(di(Tt.ARTIST_ALBUMS_APPEARSON,this.track?.artists[0].name,this.track?.artists[0].name,this.track?.artists[0].uri)),!0):e==ks.ArtistShowAlbumsCompilation?(this.dispatchEvent(di(Tt.ARTIST_ALBUMS_COMPILATION,this.track?.artists[0].name,this.track?.artists[0].name,this.track?.artists[0].uri)),!0):e==ks.ArtistShowAlbumsSingle?(this.dispatchEvent(di(Tt.ARTIST_ALBUMS_SINGLE,this.track?.artists[0].name,this.track?.artists[0].name,this.track?.artists[0].uri)),!0):e==ks.ArtistShowRelatedArtists?(this.dispatchEvent(di(Tt.ARTIST_RELATED_ARTISTS,this.track?.artists[0].name,this.track?.artists[0].name,this.track?.artists[0].uri)),!0):e==ks.ArtistShowTopTracks?(this.dispatchEvent(di(Tt.ARTIST_TOP_TRACKS,this.track?.artists[0].name,this.track?.artists[0].name,this.track?.artists[0].uri)),!0):e==ks.TrackCopyPresetToClipboard?(it(Ei(this.track,this.track?.artists[0].name)),this.alertInfoSet(be),!0):e==ks.TrackCopyPresetJsonToClipboard?(it(_i(this.track,this.track?.artists[0].name)),this.alertInfoSet(Ce),!0):e==ks.TrackCopyUriToClipboard?(it(this.track?.uri||""),!0):e==ks.TrackSearchPlaylists?(this.dispatchEvent(di(Tt.PLAYLISTS,this.track?.name+" "+this.track?.artists[0].name)),!0):e==ks.TrackSearchRadio?(this.dispatchEvent(di(Tt.PLAYLISTS,this.track?.name+ve+this.track?.artists[0].name)),!0):(this.progressShow(),e==ks.AlbumUserPresetAdd?(this.store.config.userPresets?.unshift(ki(this.track?.album)),await Bi(this.store.config),this.progressHide()):e==ks.AlbumFavoriteAdd?(await this.spotifyPlusService.SaveAlbumFavorites(this.player,this.track?.album.id),this.updateActions(this.player,[ks.AlbumFavoriteUpdate])):e==ks.AlbumFavoriteRemove?(await this.spotifyPlusService.RemoveAlbumFavorites(this.player,this.track?.album.id),this.updateActions(this.player,[ks.AlbumFavoriteUpdate])):e==ks.AlbumPlay?(await this.spotifyPlusService.PlayerMediaPlayContext(this.player,this.track?.album.uri),this.progressHide(),this.store.card.SetSection(Qe.PLAYER)):e==ks.AlbumPlayTrackFavorites?(await this.spotifyPlusService.PlayerMediaPlayTrackFavorites(this.player,null,!0,null,!1,999,null,this.track?.album.uri),this.progressHide(),this.store.card.SetSection(Qe.PLAYER)):e==ks.ArtistUserPresetAdd?this.track&&(this.track.artists[0].image_url=this.track?.album.image_url,this.store.config.userPresets?.unshift(ki(this.track?.artists[0])),await Bi(this.store.config),this.progressHide()):e==ks.ArtistFavoriteAdd?(await this.spotifyPlusService.FollowArtists(this.player,this.track?.artists[0].id),this.updateActions(this.player,[ks.ArtistFavoriteUpdate])):e==ks.ArtistFavoriteRemove?(await this.spotifyPlusService.UnfollowArtists(this.player,this.track?.artists[0].id),this.updateActions(this.player,[ks.ArtistFavoriteUpdate])):e==ks.ArtistPlayTrackFavorites?(await this.spotifyPlusService.PlayerMediaPlayTrackFavorites(this.player,null,!0,null,!1,999,this.track?.artists[0].uri,null),this.progressHide(),this.store.card.SetSection(Qe.PLAYER)):e==ks.TrackUserPresetAdd?(this.store.config.userPresets?.unshift(ki(this.track)),await Bi(this.store.config),this.progressHide()):e==ks.TrackFavoriteAdd?(await this.spotifyPlusService.SaveTrackFavorites(this.player,this.track?.id),this.updateActions(this.player,[ks.TrackFavoriteUpdate])):e==ks.TrackFavoriteRemove?(await this.spotifyPlusService.RemoveTrackFavorites(this.player,this.track?.id),this.updateActions(this.player,[ks.TrackFavoriteUpdate])):this.progressHide(),!0))}catch(e){return this.progressHide(),this.alertErrorSet("Track action failed: "+ft(e)),!0}}updateActions(e,t){if(!super.updateActions(e,t))return!1;try{const i=new Array;if(-1!=t.indexOf(ks.GetPlayingItem)||0==t.length){this.isAlbumFavorite=void 0,this.isArtistFavorite=void 0,this.isTrackFavorite=void 0;const t=new Promise(((t,i)=>{const s=Ii(this.player.attributes.media_content_id);this.spotifyPlusService.GetTrack(e,s).then((i=>{this.track=i,setTimeout((()=>{this.updateActions(e,[ks.TrackFavoriteUpdate,ks.AlbumFavoriteUpdate,ks.ArtistFavoriteUpdate])}),50),t(!0)})).catch((e=>{this.track=void 0,this.alertErrorSet("Get Track call failed: "+ft(e)),i(e)}))}));i.push(t)}if(-1!=t.indexOf(ks.AlbumFavoriteUpdate)){const t=new Promise(((t,i)=>{this.spotifyPlusService.CheckAlbumFavorites(e,this.track?.album.id).then((e=>{this.isAlbumFavorite=e[Object.keys(e)[0]],t(!0)})).catch((e=>{this.isAlbumFavorite=void 0,this.alertErrorSet("Check Album Favorites failed: "+ft(e)),i(e)}))}));i.push(t)}if(-1!=t.indexOf(ks.ArtistFavoriteUpdate)){const t=new Promise(((t,i)=>{this.spotifyPlusService.CheckArtistsFollowing(e,this.track?.artists[0].id).then((e=>{this.isArtistFavorite=e[Object.keys(e)[0]],t(!0)})).catch((e=>{this.isArtistFavorite=void 0,this.alertErrorSet("Check Artist Favorites failed: "+ft(e)),i(e)}))}));i.push(t)}if(-1!=t.indexOf(ks.TrackFavoriteUpdate)){const t=new Promise(((t,i)=>{let s=this.track?.id;this.track?.is_linked_from&&(s=this.track?.id+","+this.track?.id_origin),this.spotifyPlusService.CheckTrackFavorites(e,s).then((e=>{const i=Object.keys(e);this.isTrackFavorite=e[i[0]],i.length>1&&(this.isTrackFavorite=e[i[0]]||e[i[1]]),t(!0)})).catch((e=>{this.isTrackFavorite=void 0,this.alertErrorSet("Check Track Favorites failed: "+ft(e)),i(e)}))}));i.push(t)}return this.progressShow(),Promise.allSettled(i).finally((()=>{this.progressHide(),this.updateActionsComplete(t)})),!0}catch(e){return this.progressHide(),this.alertErrorSet("Track actions refresh failed: "+ft(e)),!0}}}Ie([Ve()],$s.prototype,"isAlbumFavorite",void 0),Ie([Ve()],$s.prototype,"isArtistFavorite",void 0),Ie([Ve()],$s.prototype,"isTrackFavorite",void 0),Ie([Ve()],$s.prototype,"track",void 0),customElements.define("spc-player-body-track",$s);const Ps=Pe(de+":player-controls"),{NEXT_TRACK:Fs,PAUSE:Ls,PLAY:Os,PREVIOUS_TRACK:Rs,REPEAT_SET:Ms,SHUFFLE_SET:xs,TURN_ON:Us,TURN_OFF:Hs}=yi,Bs=9e11,Vs=99e10,Ds=999e9;class Ns extends ri{render(){this.config=this.store.config,this.player=this.store.player,this.mediaControlService=this.store.mediaControlService,this.spotifyPlusService=this.store.spotifyPlusService;const e=[bi.ON,bi.PLAYING,bi.PAUSED,bi.BUFFERING].includes(this.player.state)&&V,t=[bi.IDLE].includes(this.player.state)&&V,i=[bi.OFF].includes(this.player.state)&&V,s=[Ai.ONE,Ai.ALL].includes(this.player.attributes.repeat||Ai.OFF),r=this.player.attributes.shuffle,o=this.player.state==bi.PAUSED,a=this.player.state==bi.OFF,n=this.isActionFavoritesVisible,l=this.isQueueItemsVisible;return H`
      <div class="player-controls-container" style=${this.styleContainer(t,i)}>
          ...
          <div class="iconsPower" hide=${i}>
              <ha-icon-button @click=${()=>this.onClickAction(Us)}        hide=${this.hideFeature(Us)}        .path=${zt} label="Turn On" style=${this.styleIcon(a)}></ha-icon-button>
          ...
          <div class="iconsPower" hide=${t}>
              <ha-icon-button @click=${()=>this.onClickAction(Hs)}       hide=${this.hideFeature(Hs)}       .path=${zt} label="Turn Off"></ha-icon-button>
    ...
    `}static get styles(){return a`
      ...
      `}});const Qr=Pe(de+":editor");class eo extends Er{constructor(){super(...arguments),this.configArea=et.GENERAL,this.onFooterShowSection=e=>{const t=ct(e.detail);this.configArea=t,xi.selectedConfigArea=this.configArea}}render(){return this.hass&&this.config?(super.createStore(),H`
      <ha-control-button-group>
