...
var So = (t, e, n) => e in t ? Oo(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var q = (t, e, n) => So(t, typeof e != "symbol" ? e + "" : e, n), zr = (t, e, n) => e.has(t) || Zi("Cannot " + n);
var p = (t, e, n) => (zr(t, e, "read from private field"), n ? n.call(t) : e.get(t)), R = (t, e, n) => e.has(t) ? Zi("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), T = (t, e, n, i) => (zr(t, e, "write to private field"), i ? i.call(t, n) : e.set(t, n), n), z = (t, e, n) => (zr(t, e, "access private method"), n);
var Hs;
typeof window < "u" && ((Hs = window.__svelte ?? (window.__svelte = {})).v ?? (Hs.v = /* @__PURE__ */ new Set())).add("5");
const xo = {
  icon: "",
  "arrow-color": "",
  "icon-rotate-degree": "",
  ...
  "title",
  "style"
], No = { icon: {} }, Co = { text: {} }, Ro = { text: { multiline: !0 } }, Io = { boolean: {} }, Lo = (t) => ({
  number: {
        ...
        schema: [
          {
            ...
            schema: [
              ...
              {
                ...es("min-width-expanded", "Min width expanded", "px")
              },
              {
                ...es("max-width-expanded", "Max width expanded", "px")
              },
              {
...
let or = kn.cardHelpers;
const Ho = new Promise((t) => {
  or && t(), kn.loadCardHelpers && kn.loadCardHelpers().then((e) => {
    or = e, kn.cardHelpers = or, t();
  });
});
async function jo() {
...
const Fo = async () => {
  const t = await Ho.then(() => or.createCardElement({ type: "vertical-stack", cards: [] })), e = await customElements.whenDefined("hui-vertical-stack-card").then(() => t.constructor.getConfigElement()), n = await jo();
  return class extends e.constructor {
      ...
      super(), this.showDialogCallback = (r) => {
        ...
        ((l = (o = (a = r.detail) == null ? void 0 : a.dialogParams) == null ? void 0 : o.schema) == null ? void 0 : l.find((c) => c.name === "expander_card_title_card_marker")) && (r.stopPropagation(), (u = r.detail) != null && u.dialogImport && r.detail.dialogImport().then(async () => {
          ...
          const c = {
            ...
            cancel: (y = (w = r.detail) == null ? void 0 : w.dialogParams) == null ? void 0 : y.cancel,
        ...
        const s = r.detail.value, a = Object.entries(xo);
        for (const [o, l] of a) {
    ...
    get _schema() {
      const s = JSON.stringify(Do), a = this._users.map((u) => u.replace(/\\/g, "\\\\").replace(/"/g, '\\"')).join('","');
      ...
      return o = o.replace(
        ...
        To.filter((u) => {
          var c;
          return !((c = this._config.templates) != null && c.some((f) => f.template === u));
        }).join('","')
      ), JSON.parse(o);
    }
...
}), Uo = 1, Go = 2, zo = 16, Bo = 1, Vo = 2, Fs = "[", Rr = "[!", wi = "]", Bt = {}, J = Symbol(), Wo = "http://www.w3.org/1999/xhtml", ii = !1;
var qs = Array.isArray, Yo = Array.prototype.indexOf, Ir = Array.from, _r = Object.keys, gr = Object.defineProperty, un = Object.getOwnPropertyDescriptor, Jo = Object.getOwnPropertyDescriptors, Ko = Object.prototype, Qo = Array.prototype, Us = Object.getPrototypeOf, ts = Object.isExtensible;
function Xo(t) {
...
const Q = 2, mr = 4, Lr = 8, zs = 1 << 24, nt = 16, rt = 32, xt = 64, Ei = 128, we = 512, ee = 1024, ae = 2048, it = 4096, de = 8192, et = 16384, kr = 32768, mn = 65536, ns = 1 << 17, Bs = 1 << 18, Kt = 1 << 19, Zo = 1 << 20, gt = 1 << 25, Vt = 32768, si = 1 << 21, $i = 1 << 22, yt = 1 << 23, lr = Symbol("$state"), el = Symbol("legacy props"), tl = Symbol(""), ln = new class extends Error {
  constructor() {
    super(...arguments);
...
function Xs(t) {
  if (t !== null)
    for (const e of t)
      (e.f & Q) === 0 || (e.f & Vt) === 0 || (e.f ^= Vt, Xs(
        /** @type {Derived} */
        e.deps
      ));
}
function Zs(t, e, n) {
  (t.f & ae) !== 0 ? e.add(t) : (t.f & it) !== 0 && n.add(t), Xs(t.deps), V(t, ee);
}
const rr = /* @__PURE__ */ new Set();
let D = null, K = null, ye = [], Dr = null, ai = !1, Pn = !1;
var fn, hn, Pt, Dt, Vn, pn, vn, Ae, oi, li, ea, ta;
const Tr = class Tr {
  constructor() {
    R(this, Ae);
    q(this, "committed", !1);
  ...
  process(e) {
    ...
    var n = [], i = [];
    for (const s of e)
      z(this, Ae, oi).call(this, s, n, i);
    this.is_fork || z(this, Ae, ea).call(this), this.is_deferred() ? (z(this, Ae, li).call(this, i), z(this, Ae, li).call(this, n)) : (D = null, rs(i), rs(n), (r = p(this, Vn)) == null || r.resolve()), K = null;
  }
  /**
  ...
  settled() {
    return (p(this, Vn) ?? T(this, Vn, Gs())).promise;
  }
  static ensure() {
    if (D === null) {
      const e = D = new Tr();
      rr.add(D), Pn || Tr.enqueue(() => {
        D === e && e.flush();
      });
    }
    return D;
...
oi = function(e, n, i) {
  ...
  for (var r = e.first, s = null; r !== null; ) {
    ...
    if (!u && r.fn !== null) {
      o ? r.f ^= ee : s !== null && (a & (mr | Lr | zs)) !== 0 ? s.b.defer_effect(r) : (a & mr) !== 0 ? n.push(r) : Qn(r) && ((a & nt) !== 0 && p(this, pn).add(r), Un(r));
      var c = r.first;
      if (c !== null) {
        r = c;
        continue;
...
li = function(e) {
  for (var n = 0; n < e.length; n += 1)
    Zs(e[n], p(this, pn), p(this, vn));
}, ea = function() {
  if (p(this, Dt) === 0) {
    for (const e of p(this, fn)) e();
    p(this, fn).clear();
  }
  p(this, Pt) === 0 && z(this, Ae, ta).call(this);
}, ta = function() {
  var r;
  if (rr.size > 1) {
    this.previous.clear();
...
function me(t) {
  ...
  try {
    for (var n; ; ) {
      if (gl(), ye.length === 0 && (D == null || D.flush(), ye.length === 0))
...
function rs(t) {
  ...
  if (e !== 0) {
    for (var n = 0; n < e; ) {
      var i = t[n++];
      if ((i.f & (et | de)) === 0 && Qn(i) && (Te = /* @__PURE__ */ new Set(), Un(i), i.deps === null && i.first === null && i.nodes === null && (i.teardown === null && i.ac === null ? $a(i) : i.fn = null), (Te == null ? void 0 : Te.size) > 0)) {
        bt.clear();
        for (const r of Te) {
  ...
  if (!n.has(t) && (n.add(t), t.reactions !== null))
    for (const r of t.reactions) {
      ...
      (s & Q) !== 0 ? ra(
        ...
        n,
        i
      ) : (s & ($i | nt)) !== 0 && (s & ae) === 0 && ia(r, e, i) && (V(r, ae), tt(
        /** @type {Effect} */
        r
      ));
    }
...
var ce, Wn, je, Mt, Fe, _e, oe, qe, Je, vt, Ht, Ke, jt, _n, gn, _t, Nr, G, sa, aa, ci, cr, ur, ui;
class $l {
  /**
  ...
  constructor(e, n, i) {
     ...
     */
    R(this, _t, null);
    R(this, Nr, bl(() => (T(this, _t, Wt(p(this, Ht))), () => {
      T(this, _t, null);
    })));
    T(this, ce, e), T(this, je, n), T(this, Mt, i), this.parent = /** @type {Effect} */
    P.b, this.is_pending = !!p(this, je).pending, T(this, Fe, Ri(() => {
      if (P.b = this, L) {
        const s = p(this, Wn);
        yn(), /** @type {Comment} */
        s.nodeType === Qt && /** @type {Comment} */
        s.data === Rr ? z(this, G, aa).call(this) : (z(this, G, sa).call(this), p(this, Ke) === 0 && (this.is_pending = !1));
      } else {
        var r = z(this, G, ci).call(this);
        try {
          T(this, _e, be(() => i(r)));
        } catch (s) {
          this.error(s);
        }
        p(this, Ke) > 0 ? z(this, G, ur).call(this) : this.is_pending = !1;
      }
      return () => {
        var s;
  ...
  update_pending_count(e) {
    z(this, G, ui).call(this, e), T(this, Ht, p(this, Ht) + e), p(this, _t) && En(p(this, _t), p(this, Ht));
  }
  get_effect_pending() {
  ...
  error(e) {
    ...
    const a = () => {
      ...
      r = !0, s && fl(), Ge.ensure(), T(this, Ht, 0), p(this, qe) !== null && qt(p(this, qe), () => {
        T(this, qe, null);
      }), this.is_pending = this.has_pending_snippet(), T(this, _e, z(this, G, cr).call(this, () => (T(this, jt, !1), be(() => p(this, Mt).call(this, p(this, ce)))))), p(this, Ke) > 0 ? z(this, G, ur).call(this) : this.is_pending = !1;
    };
    var o = N;
    try {
    ...
    i && Pr(() => {
      T(this, qe, z(this, G, cr).call(this, () => {
...
ce = new WeakMap(), Wn = new WeakMap(), je = new WeakMap(), Mt = new WeakMap(), Fe = new WeakMap(), _e = new WeakMap(), oe = new WeakMap(), qe = new WeakMap(), Je = new WeakMap(), vt = new WeakMap(), Ht = new WeakMap(), Ke = new WeakMap(), jt = new WeakMap(), _n = new WeakMap(), gn = new WeakMap(), _t = new WeakMap(), Nr = new WeakMap(), G = new WeakSet(), sa = function() {
  try {
  ...
  e && (T(this, oe, be(() => e(p(this, ce)))), Ge.enqueue(() => {
    var n = z(this, G, ci).call(this);
    T(this, _e, z(this, G, cr).call(this, () => (Ge.ensure(), be(() => p(this, Mt).call(this, n))))), p(this, Ke) > 0 ? z(this, G, ur).call(this) : (qt(
      /** @type {Effect} */
      p(this, oe),
      () => {
        T(this, oe, null);
...
cr = function(e) {
  ...
  p(this, _e) !== null && (T(this, Je, document.createDocumentFragment()), p(this, Je).append(
    /** @type {TemplateNode} */
    p(this, vt)
  ), Sa(p(this, _e), p(this, Je))), p(this, oe) === null && T(this, oe, be(() => e(p(this, ce))));
}, /**
...
ui = function(e) {
  ...
  if (!this.has_pending_snippet()) {
    this.parent && z(n = this.parent, G, ui).call(n, e);
    return;
  }
...
function Al(t, e, n, i) {
  ...
  function l() {
    Promise.all(n.map((u) => /* @__PURE__ */ Sl(u))).then((u) => {
      o();
      try {
        i([...e.map(r), ...u]);
      } catch (c) {
...
function la(t) {
  var e = Ti(t);
  if (!t.equals(e) && (t.wv = Na(), (!(D != null && D.is_fork) || t.deps === null) && (t.v = e, t.deps === null))) {
    V(t, ee);
    return;
  }
  At || (K !== null ? (Ni() || D != null && D.is_fork) && K.set(t, e) : xi(t));
}
...
function En(t, e) {
  if (!t.equals(e)) {
    ...
    t.wv = Na(), da(t, ae), P !== null && (P.f & ee) !== 0 && (P.f & (rt | xt)) === 0 && (pe === null ? Ml([t]) : pe.push(t)), !i.is_fork && di.size > 0 && !ca && Nl();
  }
  return e;
}
function Nl() {
  ...
  if (n !== null)
    for (var i = n.length, r = 0; r < i; r++) {
      ...
      if (o && V(s, e), (a & Q) !== 0) {
        ...
        K == null || K.delete(l), (a & Vt) === 0 && (a & we && (s.f |= Vt), da(l, it));
...
function Xe(t) {
  if (typeof t != "object" || t === null || lr in t)
    return t;
  const e = Us(t);
  if (e !== Ko && e !== Qo)
    return t;
  var n = /* @__PURE__ */ new Map(), i = qs(t), r = /* @__PURE__ */ M(0), s = Gt, a = (o) => {
    if (Gt === s)
      return o();
    var l = N, u = Gt;
    Z(null), os(s);
  ...
  return i && n.set("length", /* @__PURE__ */ M(
    ...
    t,
    {
      defineProperty(o, l, u) {
        (!("value" in u) || u.configurable === !1 || u.enumerable === !1 || u.writable === !1) && cl();
        var c = n.get(l);
        return c === void 0 ? c = a(() => {
      ...
      get(o, l, u) {
        ...
        if (c === void 0 && (!f || (w = un(o, l)) != null && w.writable) && (c = a(() => {
          var y = Xe(f ? o[l] : J), A = /* @__PURE__ */ M(y);
          return A;
        }), n.set(l, c)), c !== void 0) {
          var _ = h(c);
          return _ === J ? void 0 : _;
      ...
      has(o, l) {
        ...
        if (u !== void 0 || P !== null && (!c || (_ = un(o, l)) != null && _.writable)) {
          u === void 0 && (u = a(() => {
            var w = c ? Xe(o[l]) : J, y = /* @__PURE__ */ M(w);
            return y;
          }), n.set(l, u));
          var f = h(u);
          if (f === J)
      ...
      set(o, l, u, c) {
        ...
        if (i && l === "length")
          ...
          f.v; w += 1) {
            var y = n.get(w + "");
            y !== void 0 ? O(y, J) : w in o && (y = a(() => /* @__PURE__ */ M(J)), n.set(w + "", y));
          }
        if (f === void 0)
          (!_ || (m = un(o, l)) != null && m.writable) && (f = a(() => /* @__PURE__ */ M(void 0)), O(f, Xe(u)), n.set(l, f));
        else {
          _ = f.v !== J;
          var A = a(() => Xe(u));
          O(f, A);
...
function fi() {
  if (is === void 0) {
    is = window, fa = /Firefox/.test(navigator.userAgent);
    var t = Element.prototype, e = Node.prototype, n = Text.prototype;
    ha = un(e, "firstChild").get, pa = un(e, "nextSibling").get, ts(t) && (t.__click = void 0, t.__className = void 0, t.__attributes = null, t.__style = void 0, t.__e = void 0), ts(n) && (n.__t = void 0);
  }
}
function Ee(t = "") {
...
function ss(t, e = !1) {
  ...
  if (e && (I == null ? void 0 : I.nodeType) !== Ai) {
    var i = Ee();
...
function Ct(t, e = 1, n = !1) {
  ...
  if (!L)
    return i;
  if (n && (i == null ? void 0 : i.nodeType) !== Ai) {
    var s = Ee();
...
function ze(t, e, n) {
  ...
  (s.f & Kt) === 0 && (s = s.first, (t & nt) !== 0 && (t & mn) !== 0 && s !== null && (s.f |= mn)), s !== null && (s.parent = i, i !== null && Rl(s, i), N !== null && (N.f & Q) !== 0 && (t & xt) === 0)) {
    var a = (
      /** @type {Derived} */
      N
    );
...
function ie(t, e = !0) {
  var n = !1;
  (e || (t.f & Bs) !== 0) && t.nodes !== null && t.nodes.end !== null && (Ea(
    t.nodes.start,
    /** @type {TemplateNode} */
    t.nodes.end
  ), n = !0), wa(t, e && !n), Er(t, 0), V(t, et);
  ...
  ba(t);
  var r = t.parent;
  r !== null && r.first !== null && $a(t), t.next = t.prev = t.teardown = t.ctx = t.deps = t.fn = t.nodes = t.ac = null;
}
function Ea(t, e) {
  for (; t !== null; ) {
...
function Ra(t) {
  ...
  ne = /** @type {null | Value[]} */
  null, le = 0, pe = null, N = (u & (rt | xt)) === 0 ? t : null, se = null, bn(t.ctx), De = !1, Gt = ++qn, t.ac !== null && (ga(() => {
    t.ac.abort(ln);
  }), t.ac = null);
  try {
    t.f |= si;
    ...
    } else _ !== null && le < _.length && (Er(t, le), _.length = le);
    if (Js() && pe !== null && !De && _ !== null && (t.f & (Q | it | ae)) === 0)
    ...
    t.f ^= si, ne = e, le = n, pe = i, N = r, se = s, bn(a), De = o, Gt = l;
  }
}
function Hl(t, e) {
  let n = e.reactions;
  ...
  (ne === null || !ne.includes(e))) {
    ...
    (s.f & we) !== 0 && (s.f ^= we, s.f &= ~Vt), xi(s), oa(s), Er(s, 0);
  }
}
function Er(t, e) {
  var n = t.deps;
...
function Un(t) {
  ...
  if ((e & et) === 0) {
    ...
    P = t, Ut = !0;
    try {
      (e & (nt | zs)) !== 0 ? Dl(t) : wa(t), ba(t);
      var r = Ra(t);
      t.teardown = typeof r == "function" ? r : null, t.wv = Ta;
      var s;
      ii && _l && (t.f & ae) !== 0 && t.deps;
    } finally {
      Ut = i, P = n;
    }
  }
...
function h(t) {
  ...
  if (n) {
    ...
    if (At) {
      var o = a.v;
      return ((a.f & ee) === 0 && a.reactions !== null || La(a)) && (o = Ti(a)), bt.set(a, o), o;
    }
    var l = (a.f & we) === 0 && !De && N !== null && (Ut || (N.f & we) !== 0), u = a.deps === null;
    Qn(a) && (l && (a.f |= we), la(a)), l && !u && Ia(a);
  }
  if (K != null && K.has(t))
    return K.get(t);
  if ((t.f & yt) !== 0)
...
function Ia(t) {
  if (t.deps !== null) {
    ...
    for (const e of t.deps)
      (e.reactions ?? (e.reactions = [])).push(t), (e.f & Q) !== 0 && (e.f & we) === 0 && Ia(
        /** @type {Derived} */
        e
      );
  }
...
const ka = /* @__PURE__ */ new Set(), hi = /* @__PURE__ */ new Set();
function jl(t) {
  for (var e = 0; e < t.length; e++)
    ka.add(t[e]);
  for (var n of hi)
...
// @__NO_SIDE_EFFECTS__
function st(t, e) {
  var n = (e & Bo) !== 0, i = (e & Vo) !== 0, r, s = !t.startsWith("<!>");
  return () => {
    if (L)
      return wt(I, null), I;
    r === void 0 && (r = Pa(s ? t : "<!>" + t), n || (r = /** @type {TemplateNode} */
    /* @__PURE__ */ Pe(r)));
    var a = (
      /** @type {TemplateNode} */
      i || fa ? document.importNode(r, !0) : r.cloneNode(!0)
    );
    if (n) {
      var o = (
        /** @type {TemplateNode} */
...
function ve(t, e) {
  if (L) {
    ...
    ((n.f & kr) === 0 || n.nodes.end === null) && (n.nodes.end = I), yn();
    return;
  }
  t !== null && t.before(
    /** @type {Node} */
...
`).some((o) => o.startsWith("https://svelte.dev/e/")))
      throw a;
    return a !== Bt && console.warn("Failed to hydrate: ", a), e.recover === !1 && ll(), fi(), va(n), ke(!1), Da(t, e);
  } finally {
    ke(i), re(r);
  }
}
const rn = /* @__PURE__ */ new Map();
function Ma(t, { target: e, anchor: n, props: i = {}, events: r, context: s, intro: a = !0 }) {
  fi();
  var o = /* @__PURE__ */ new Set(), l = (f) => {
    for (var _ = 0; _ < f.length; _++) {
      ...
      if (!o.has(w)) {
        o.add(w);
        var y = ql(w);
        e.addEventListener(w, ir, { passive: y });
        var A = rn.get(w);
        A === void 0 ? (document.addEventListener(w, ir, { passive: y }), rn.set(w, 1)) : rn.set(w, A + 1);
      }
    }
  };
  l(Ir(ka)), hi.add(l);
...
class Bl {
        ...
        for (const [s, a] of p(this, Ue)) {
          ...
          const o = () => {
            if (Array.from(p(this, Ce).values()).includes(s)) {
              ...
              Sa(a, u), u.append(Ee()), p(this, ue).set(s, { effect: a, fragment: u });
            } else
              ie(a);
   ...
   */
    ...
    if (p(this, Ce).set(i, e), r) {
      ...
      i.oncommit(p(this, Jn)), i.ondiscard(p(this, Cr));
    } else
      L && (this.anchor = I), p(this, Jn).call(this);
  }
}
Ce = new WeakMap(), Ue = new WeakMap(), ue = new WeakMap(), Ft = new WeakMap(), Yn = new WeakMap(), Jn = new WeakMap(), Cr = new WeakMap();
function Ha(t) {
  fe === null && nl(), dn(() => {
    const e = Re(t);
...
function Wl(t, e, n, i, r, s = null) {
  ...
  L && yn();
  var u = null, c = /* @__PURE__ */ xl(() => {
    var d = n();
    return qs(d) ? d : d == null ? [] : Ir(d);
  }), f, _ = !0;
  function w() {
    A.fallback = u, Yl(A, f, a, e, i), u !== null && (f.length === 0 ? (u.f & gt) === 0 ? Ii(u) : (u.f ^= gt, Ln(u, null, a)) : qt(u, () => {
      u = null;
    }));
  }
  var y = Ri(() => {
    ...
    for (var m = /* @__PURE__ */ new Set(), S = (
      ...
      I.data === wi && (a = /** @type {Comment} */
      I, v = !0, ke(!1));
      var k = f[C], F = i(k, C), H = _ ? null : o.get(F);
      H ? (H.v && En(H.v, k), H.i && En(H.i, C), x && S.skipped_effects.delete(H.e)) : (H = Jl(
        o,
        _ ? a : us ?? (us = Ee()),
        k,
        F,
        ...
        e,
        n
      ), _ || (H.e.f |= gt), o.set(F, H)), m.add(F);
    }
    if (d === 0 && s && !u && (_ ? u = be(() => s(a)) : (u = be(() => s(us ?? (us = Ee()))), u.f |= gt)), L && d > 0 && re(yr()), !_)
      if (x) {
        for (const [tr, On] of o)
          m.has(tr) || S.skipped_effects.add(On.e);
        S.oncommit(w), S.ondiscard(() => {
        });
      } else
        w();
    v && ke(!0), h(c);
  }), A = { effect: y, items: o, outrogroups: null, fallback: u };
  _ = !1, L && (a = I);
}
function Yl(t, e, n, i, r) {
  var F;
  var s = e.length, a = t.items, o = t.effect.first, l, u = null, c = [], f = [], _, w, y, A;
  for (A = 0; A < s; A += 1) {
    if (_ = e[A], w = r(_, A), y = /** @type {EachItem} */
    ...
    if ((y.f & gt) !== 0)
      if (y.f ^= gt, y === o)
        ...
        var d = u ? u.next : o;
        y === t.effect.last && (t.effect.last = y.prev), y.prev && (y.prev.next = y.next), y.next && (y.next.prev = y.prev), ot(t, u, y), ot(t, y, d), Ln(y, d, n), u = y, c = [], f = [], o = u.next;
        continue;
      }
    if ((y.f & de) !== 0 && Ii(y), y !== o) {
      if (l !== void 0 && l.has(y)) {
        if (c.length < f.length) {
          var v = f[0], g;
          u = v.prev;
          var m = c[0], S = c[c.length - 1];
          for (g = 0; g < c.length; g += 1)
            Ln(c[g], v, n);
          for (g = 0; g < f.length; g += 1)
            l.delete(f[g]);
          ot(t, m.prev, S.next), ot(t, u, m), ot(t, S, v), o = v, u = S, A -= 1, c = [], f = [];
        } else
          l.delete(y), Ln(y, o, n), ot(t, y.prev, y.next), ot(t, y, u === null ? t.effect.first : u.next), ot(t, u, y), u = y;
        continue;
      }
      for (c = [], f = []; o !== null && o !== y; )
    ...
    (y.f & gt) === 0 && c.push(y), u = y, o = y.next;
  }
  if (t.outrogroups !== null) {
    for (const H of t.outrogroups)
      H.pending.size === 0 && (vi(Ir(H.done)), (F = t.outrogroups) == null || F.delete(H));
...
function Jl(t, e, n, i, r, s, a, o) {
  var l = (a & Uo) !== 0 ? (a & zo) === 0 ? /* @__PURE__ */ ua(n, !1, !1) : Wt(n) : null, u = (a & Go) !== 0 ? Wt(r) : null;
  return {
    v: l,
    i: u,
    e: be(() => (s(e, l ?? n, u ?? r, o), () => {
...
const Zl = Symbol("is custom element"), ec = Symbol("is html");
function Fa(t, e, n, i) {
  var r = tc(t);
  L && (r[e] = t.getAttribute(e), e === "src" || e === "srcset" || e === "href" && t.nodeName === "LINK") || r[e] !== (r[e] = n) && (e === "loading" && (t[tl] = n), n == null ? t.removeAttribute(e) : typeof n != "string" && qa(t).includes(e) ? t[e] = n : t.setAttribute(e, n));
}
function ds(t, e, n) {
  var i = N, r = P;
  let s = L;
  ...
  try {
    ...
    !customElements || customElements.get(t.getAttribute("is") || t.tagName.toLowerCase()) ? qa(t).includes(e) : n && typeof n == "object") ? t[e] = n : Fa(t, e, n == null ? n : String(n));
  } finally {
    Z(i), $e(r), s && ke(!0);
  }
}
...
function fs(t, e) {
  return t === e || (t == null ? void 0 : t[lr]) === e;
}
function ft(t = {}, e, n, i) {
  return ya(() => {
    var r, s;
    return Ci(() => {
      r = s, s = [], Re(() => {
        t !== n(...s) && (e(t, ...s), r && fs(n(...r), t) && e(null, ...r));
      });
    }), () => {
      Pr(() => {
        s && fs(n(...s), t) && e(null, ...s);
  ...
  return (
    ...
    (function(_, w) {
      if (arguments.length > 0) {
        const y = w ? h(c) : _;
        return O(c, y), u = !0, r !== void 0 && (r = y), _;
      }
  ...
  constructor(e) {
    ...
    const r = new Proxy(
      { ...e.props || {}, $$events: {} },
      {
        ...
        has(a, o) {
          return o === el ? !0 : (h(n.get(o) ?? i(o, Reflect.get(a, o))), Reflect.has(a, o));
        },
        set(a, o, l) {
    ...
    T(this, ge, (e.hydrate ? Gl : Da)(e.component, {
      target: e.target,
      anchor: e.anchor,
      props: r,
      context: e.context,
...
typeof HTMLElement == "function" && (Ua = class extends HTMLElement {
  ...
  async connectedCallback() {
    if (this.$$cn = !0, !this.$$c) {
      ...
      for (const r of this.attributes) {
        ...
        s in this.$$d || (this.$$d[s] = dr(s, r.value, this.$$p_d, "toProp"));
      }
  ...
  attributeChangedCallback(e, n, i) {
    var r;
    this.$$r || (e = this.$$g_p(e), this.$$d[e] = dr(e, i, this.$$p_d, "toProp"), (r = this.$$c) == null || r.$set({ [e]: this.$$d[e] }));
  }
  disconnectedCallback() {
...
class Li extends Error {
  ...
  constructor(e, ...n) {
    super(...n), Error.captureStackTrace && Error.captureStackTrace(this, Li), this.name = "TimeoutError", this.timeout = e, this.message = `Timed out in ${e} ms.`;
  }
}
const sc = (t, e) => {
  ...
  return customElements.get(t.localName) ? 1 : customElements.whenDefined(t.localName).then(() => za(t));
};
var ac = /* @__PURE__ */ st('<span class="loading svelte-lv9s7p">Loading...</span>'), oc = /* @__PURE__ */ st("<div><!></div>");
const lc = {
  hash: "svelte-lv9s7p",
...
function gi(t, e) {
  ...
  dn(() => {
    ...
    m.hass = i(), m.preview = r(), y.disabled = !a(), m.config = y, m.load(), c == null || c.appendChild(m), O(f, m, !0), O(_, !1), h(f).addEventListener(
      "ll-upgrade",
      (S) => {
        var x;
      ...
      { capture: !0 }
    ), u() && (m.style.setProperty("--ha-card-background", "transparent"), m.style.setProperty("--ha-card-box-shadow", "none"), m.style.setProperty("--ha-card-border-color", "transparent"), m.style.setProperty("--ha-card-border-width", "0px"), m.style.setProperty("--ha-card-border-radius", "0px"), m.style.setProperty("--ha-card-backdrop-filter", "none")), o() && (O(w, await za(m) * 56), c && O(w, h(w) + (window.getComputedStyle(c).marginTop ? parseFloat(window.getComputedStyle(c).marginTop) : 0)), new ResizeObserver((x) => {
      for (const C of x)
        if (C.contentBoxSize) {
...
customElements.define("expander-sub-card", Ga(
  gi,
  {
    config: {},
    hass: {},
...
var Xn = function(t, e, n) {
  ...
  return new Promise((function(f, _) {
    var w = 0, y = function() {
      var A = t();
      e(A) ? f(A) : ++w < s ? setTimeout(y, o) : u ? _(new Error(c.replace(/\{\{\s*retries\s*\}\}/g, "".concat(s)))) : f(A);
    };
    y();
  }));
}, $r = function() {
...
var Ar, cn, Ie, ht, Vr = "[home-assistant-javascript-templates]", uc = /^([a-z_]+)\.(\w+)$/;
(function(t) {
...
var hs = function(t) {
  ...
  return t.includes(".");
}, fr = "ref", Rt = "value", ps = "toJSON", vs = function(t) {
  return "".concat(fr, ".").concat(t);
};
function dc(t, e, n) {
  var i = function() {
    ...
    var g = v.with_unit, m = g !== void 0 && g, S = v.rounded, x = S !== void 0 && S;
    if (d) {
  ...
  return { get hass() {
    ...
    if (v === void 0 && (v = {}), lt(d)) return _(d), y(t.hass.states[d], v);
    ...
    return g.length || c(v), new Proxy(hs(g), { get: function(m, S) {
      return _("".concat(v, ".").concat(S)), A(m[S]);
    } });
    ...
    return this.states(d) ? !(this.is_state(d, Ar.UNKNOWN) || this.is_state(d, Ar.UNAVAILABLE)) : (u(d), !1);
    ...
    return v.length || c(d), new Proxy(hs(v), { get: function(g, m) {
    ...
    if (lt(d)) throw SyntaxError("".concat(Vr, ": devices method cannot be used with an entity id, you should use a device id instead."));
    return t.hass.devices[d];
  }), { get: function(d, v) {
    if (lt(v)) throw SyntaxError("".concat(Vr, ": devices cannot be accesed using an entity id, you should use a device id instead."));
    return t.hass.devices[v];
  } }), device_attr: function(d, v) {
    var g, m, S;
    if (lt(d)) {
      _(d);
      var x = (g = t.hass.entities[d]) === null || g === void 0 ? void 0 : g.device_id;
      return (m = t.hass.devices[x]) === null || m === void 0 ? void 0 : m[v];
    }
    ...
    if (m) return this.device_attr(m, cn.AREA_ID);
    ...
    var v, g, m;
    d in t.hass.devices && (m = this.device_attr(d, cn.AREA_ID));
    var S = (v = t.hass.entities[d]) === null || v === void 0 ? void 0 : v.device_id;
    S && (m = this.device_attr(S, cn.AREA_ID));
    var x = i().find((function(C) {
      var k = C[1];
      return k.area_id === d || k.area_id === m;
    }));
    return (g = x == null ? void 0 : x[1]) === null || g === void 0 ? void 0 : g.name;
  }, area_entities: function(d) {
    var v = i().find((function(g) {
      var m = g[1];
    ...
    var x = new Proxy(((m = {})[Rt] = g, m[ps] = function() {
      return this[Rt];
    }, m), { get: function(C, k, F) {
      if (k === Rt || k === ps) return w(S), Reflect.get(C, k, F);
      f("".concat(k, " is not a valid ").concat(fr, " property. A ").concat(fr, ' only exposes a "').concat(Rt, '" property'));
    }, set: function(C, k, F) {
      if (k === Rt) {
        var H = C[Rt];
      ...
      return f('property "'.concat(k, '" cannot be set in a ').concat(fr)), !1;
    } });
    return o.set(v, x), x;
  }, unref: function(d, v) {
    var g = vs(v);
    ...
    g === void 0 && (g = {});
    var m = this.ref, S = this.unref, x = new Proxy(g, { get: function(C, k) {
      return m(d, k).value;
    }, set: function(C, k, F) {
      return m(d, k).value = F, !0;
    } });
    return Object.entries(g).forEach((function(C) {
      var k = C[0], F = C[1];
      o.has(k) && S(v, k), m(d, k, F);
    })), x;
...
var fc = (function() {
  function t(e, n) {
    var i = n.throwErrors, r = i !== void 0 && i, s = n.throwWarnings, a = s === void 0 || s, o = n.variables, l = o === void 0 ? {} : o, u = n.refs, c = u === void 0 ? {} : u, f = n.refsVariableName, _ = f === void 0 ? "refs" : f, w = n.autoReturn, y = w === void 0 || w;
    this._throwErrors = r, this._throwWarnings = a, this._variables = l, this._refsVariableName = _, this._autoReturn = y, this._subscriptions = /* @__PURE__ */ new Map(), this._clientSideEntitiesRegExp = new RegExp("(^|[ \\?(+:\\{\\[><,])(".concat(Object.values(Ie).join("|"), ")($|[ \\?)+:\\}\\]><.,])"), "gm"), this._scopped = dc(e, r, a), this.refs = c, this._watchForPanelUrlChange(), this._watchForEntitiesChange(), this._watchForLanguageChange();
  }
  return t.prototype._executeRenderingFunctions = function(e) {
    ...
    n === void 0 && (n = {});
    try {
      var i = n.variables, r = i === void 0 ? {} : i, s = n.refs, a = s === void 0 ? {} : s, o = new Map(Object.entries($r($r({}, this._variables), r))), l = e.trim().replace(this._clientSideEntitiesRegExp, "$1clientSide.$2$3"), u = l.includes("return") || !this._autoReturn ? l : "return ".concat(l);
      return new (Function.bind.apply(Function, Br(Br([void 0, "hass", "states", "state_translated", "is_state", "state_attr", "is_state_attr", "has_value", "entities", "entity_prop", "is_entity_prop", "devices", "device_attr", "is_device_attr", "device_id", "device_name", "areas", "area_id", "area_name", "area_entities", "area_devices", "user_name", "user_is_admin", "user_is_owner", "user_agent", "clientSide", "ref", "unref", this._refsVariableName], Array.from(o.keys()), !1), ["".concat('"use strict";', " ").concat(u)], !1)))().apply(void 0, Br([this._scopped.hass, this._scopped.states, this._scopped.state_translated.bind(this._scopped), this._scopped.is_state.bind(this._scopped), this._scopped.state_attr.bind(this._scopped), this._scopped.is_state_attr.bind(this._scopped), this._scopped.has_value.bind(this._scopped), this._scopped.entities, this._scopped.entity_prop, this._scopped.is_entity_prop.bind(this._scopped), this._scopped.devices, this._scopped.device_attr.bind(this._scopped), this._scopped.is_device_attr.bind(this._scopped), this._scopped.device_id.bind(this._scopped), this._scopped.device_name.bind(this._scopped), this._scopped.areas.bind(this._scopped), this._scopped.area_id.bind(this._scopped), this._scopped.area_name.bind(this._scopped), this._scopped.area_entities.bind(this._scopped), this._scopped.area_devices.bind(this._scopped), this._scopped.user_name, this._scopped.user_is_admin, this._scopped.user_is_owner, this._scopped.user_agent, this._scopped.clientSideProxy, this._scopped.ref.bind(this._scopped, this._entityWatchCallback.bind(this)), this._scopped.unref.bind(this._scopped, this.cleanTracked.bind(this)), this._scopped.refs(this._entityWatchCallback.bind(this), this.cleanTracked.bind(this), a)], Array.from(o.values()), !1));
    } catch (c) {
...
var Yt = "$", Ba = ":host", ki = "invalid selector", Ot = 10, St = 10, Pi = function(t) {
  var e, n = t[0], i = t[1];
...
function Mi(t, e) {
  for (var n, i, r = null, s = t.length, a = 0; a < s; a++) {
    if (a === 0) if (t[a].length) r = e.querySelector(t[a]);
      ...
      if (e instanceof Document) throw new SyntaxError(Wa());
      if (e instanceof ShadowRoot) throw new SyntaxError(Ya());
      r = ((n = e.shadowRoot) === null || n === void 0 ? void 0 : n.querySelector(t[++a])) || null;
    }
    else r = ((i = r.shadowRoot) === null || i === void 0 ? void 0 : i.querySelector("".concat(Ba, " ").concat(t[a]))) || null;
...
function gc(t, e) {
  ...
  var s = Mi(i, e);
  return ((n = s == null ? void 0 : s.shadowRoot) === null || n === void 0 ? void 0 : n.querySelectorAll("".concat(Ba, " ").concat(r))) || null;
}
function mc(t, e) {
...
function yc(t, e, n, i) {
  for (var r = Di(t, (function(l) {
    if (!l[l.length - 1].length) throw new SyntaxError(Va(n, i));
    return l;
...
function bc(t, e, n) {
  for (var i = Di(t, (function(o) {
    if (!o[o.length - 1].length) throw new SyntaxError(Va(n));
    return o;
  })), r = i.length, s = 0; s < r; s++) {
    var a = gc(i[s], e);
    if (a != null && a.length) return a;
  }
  return document.querySelectorAll(ki);
}
function wc(t, e, n, i) {
  for (var r = Di(t, (function(l) {
  ...
  return Xt(this, void 0, void 0, (function() {
    return Zt(this, (function(r) {
      return [2, Xn((function() {
        return yc(t, e, "asyncQuerySelector", "asyncShadowRootQuerySelector");
      }), (function(s) {
        return !!s;
...
function ys(t, e, n, i) {
  return Xt(this, void 0, void 0, (function() {
    return Zt(this, (function(r) {
      return [2, Xn((function() {
        return bc(t, e, "asyncQuerySelectorAll");
      }), (function(s) {
        return !!s.length;
      }), { retries: n, delay: i, shouldReject: !1 })];
    }));
...
function bs(t, e, n, i) {
  return Xt(this, void 0, void 0, (function() {
    return Zt(this, (function(r) {
      return [2, Xn((function() {
        return wc(t, e, "asyncShadowRootQuerySelector", "asyncQuerySelector");
      }), (function(s) {
        return !!s;
      }), { retries: n, delay: i, shouldReject: !1 })];
    }));
...
function Es() {
  ...
  return Xt(this, void 0, void 0, (function() {
    ...
    return Zt(this, (function(o) {
      switch (o.label) {
        case 0:
          return Pi(t) ? (n = t[0], i = t[1], r = t[2], [4, ms(i, n, (r == null ? void 0 : r.retries) || Ot, (r == null ? void 0 : r.delay) || St)]) : [3, 2];
        case 1:
        case 3:
          return [2, o.sent()];
        case 2:
          return s = t[0], a = t[1], [4, ms(s, document, (a == null ? void 0 : a.retries) || Ot, (a == null ? void 0 : a.delay) || St)];
      }
    }));
  }));
}
function $s() {
  ...
  return Xt(this, void 0, void 0, (function() {
    ...
    return Zt(this, (function(o) {
      switch (o.label) {
        case 0:
          return Pi(t) ? (n = t[0], i = t[1], r = t[2], [4, ys(i, n, (r == null ? void 0 : r.retries) || Ot, (r == null ? void 0 : r.delay) || St)]) : [3, 2];
        case 1:
          return [2, o.sent()];
        case 2:
          return s = t[0], a = t[1], [2, ys(s, document, (a == null ? void 0 : a.retries) || Ot, (a == null ? void 0 : a.delay) || St)];
      }
    }));
  }));
}
function As() {
  ...
  return Xt(this, void 0, void 0, (function() {
    ...
    return Zt(this, (function(o) {
      switch (o.label) {
        case 0:
          return Pi(t) ? (n = t[0], i = t[1], r = t[2], [4, bs(i, n, (r == null ? void 0 : r.retries) || Ot, (r == null ? void 0 : r.delay) || St)]) : [3, 2];
        case 1:
          return [2, o.sent()];
        case 2:
...
var Ec = (function() {
  function t(e, n) {
    e instanceof Node || e instanceof Promise ? (this._element = e, this._asyncParams = Or({ retries: Ot, delay: St }, n || {})) : (this._element = document, this._asyncParams = Or({ retries: Ot, delay: St }, e || {}));
  }
  return Object.defineProperty(t.prototype, "element", { get: function() {
    ...
    return new t(sn(this._element).then((function(n) {
      return n instanceof Document || n instanceof ShadowRoot || n === null || n instanceof NodeList && n.length === 0 ? null : n instanceof NodeList ? As(n[0], Yt, e._asyncParams) : As(n, Yt, e._asyncParams);
    })), this._asyncParams);
  }, enumerable: !1, configurable: !0 }), Object.defineProperty(t.prototype, "all", { get: function() {
    return sn(this._element).then((function(e) {
      return e instanceof NodeList ? e : document.querySelectorAll(ki);
    }));
    ...
    return new t(sn(this._element).then((function(i) {
      return i === null || i instanceof NodeList && i.length === 0 ? null : i instanceof NodeList ? $s(i[0], e, n._asyncParams) : $s(i, e, n._asyncParams);
    })), this._asyncParams);
    ...
    return new t(sn(this._element).then((function(i) {
      return i === null || i instanceof NodeList && i.length === 0 ? null : i instanceof NodeList ? Promise.race(Array.from(i).map((function(r) {
        return ws(r, e, n._asyncParams.retries, n._asyncParams.delay);
      }))) : ws(i, e, n._asyncParams.retries, n._asyncParams.delay);
    })), this._asyncParams);
  }, t;
})(), yi = function(t, e) {
  return yi = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(n, i) {
    n.__proto__ = i;
  } || function(n, i) {
...
var Le, mt, B, Ye, Os, Wr, Yr, sr, Ss, Jr, ar, Kr, Qr, Xr, Rn, j, Et = "$", $c = { retries: 100, delay: 50, eventThreshold: 450 };
(function(t) {
...
var Ac = ((Os = {})[Le.HOME_ASSISTANT] = { selector: j.HOME_ASSISTANT, children: { shadowRoot: { selector: Et, children: (Wr = {}, Wr[Le.HOME_ASSISTANT_MAIN] = { selector: j.HOME_ASSISTANT_MAIN, children: { shadowRoot: { selector: Et, children: (Yr = {}, Yr[Le.HA_DRAWER] = { selector: j.HA_DRAWER, children: (sr = {}, sr[Le.HA_SIDEBAR] = { selector: j.HA_SIDEBAR, children: { shadowRoot: { selector: Et } } }, sr[Le.PARTIAL_PANEL_RESOLVER] = { selector: j.PARTIAL_PANEL_RESOLVER }, sr) }, Yr) } } }, Wr) } } }, Os), Oc = ((Ss = {})[mt.HA_PANEL_LOVELACE] = { selector: j.HA_PANEL_LOVELACE, children: { shadowRoot: { selector: Et, children: (Jr = {}, Jr[mt.HUI_ROOT] = { selector: j.HUI_ROOT, children: { shadowRoot: { selector: Et, children: (ar = {}, ar[mt.HEADER] = { selector: j.HEADER }, ar[mt.HUI_VIEW] = { selector: j.HUI_VIEW }, ar) } } }, Jr) } } }, Ss), Sc = { shadowRoot: { selector: Et, children: (Kr = {}, Kr[B.HA_MORE_INFO_DIALOG] = { selector: j.HA_MORE_INFO_DIALOG, children: { shadowRoot: { selector: Et, children: (Qr = {}, Qr[B.HA_DIALOG] = { selector: j.HA_DIALOG, children: (Xr = {}, Xr[B.HA_DIALOG_CONTENT] = { selector: j.HA_DIALOG_CONTENT, children: (Rn = {}, Rn[B.HA_MORE_INFO_DIALOG_INFO] = { selector: j.HA_MORE_INFO_DIALOG_INFO }, Rn[B.HA_DIALOG_MORE_INFO_HISTORY_AND_LOGBOOK] = { selector: j.HA_DIALOG_MORE_INFO_HISTORY_AND_LOGBOOK }, Rn[B.HA_DIALOG_MORE_INFO_SETTINGS] = { selector: j.HA_DIALOG_MORE_INFO_SETTINGS }, Rn) }, Xr) }, Qr) } } }, Kr) } }, Mn = function(t, e, n, i) {
  return n === void 0 && (n = null), i === void 0 && (i = !1), Object.entries(e || {}).reduce((function(r, s) {
    ...
    var l = n ? n.then((function(u) {
      return u ? Es(u, (c = o.selector, i ? "$ " + c : c), t) : null;
      var c;
    })) : Es(o.selector, t);
    return r[a] = { element: l, children: Mn(t, o.children, l), selector: new Ec(l, t) }, r;
  }), {});
}, Ja = function(t, e) {
  for (var n = 0, i = Object.entries(e); n < i.length; n++) {
    var r = i[n];
    if (r[0] === t) return r[1];
    var s = Ja(t, r[1].children);
    if (s) return s;
  }
}, Zr = function(t, e) {
  ...
  function e(n) {
    ...
    return i._config = Ze(Ze({}, $c), n), i._timestaps = {}, i;
  }
  return (function(n, i) {
    ...
    yi(n, i), n.prototype = i === null ? Object.create(i) : (r.prototype = i.prototype, new r());
    ...
    var i, r = this;
    n === void 0 && (n = B.HA_MORE_INFO_DIALOG_INFO), this._dialogTree = Mn(this._config, Sc, this._haRootElements.HOME_ASSISTANT.element);
    var s = Zr(B, this._dialogTree);
    ...
    var n = this;
    this._homeAssistantRootTree = Mn(this._config, Ac), this._haRootElements = Zr(Le, this._homeAssistantRootTree), this._haRootElements[Le.HOME_ASSISTANT].selector.$.element.then((function(i) {
    ...
    var n = this;
    this._homeAssistantResolverTree = Mn(this._config, Oc, this._haRootElements[Le.HA_DRAWER].element), this._haResolverElements = Zr(mt, this._homeAssistantResolverTree), this._haResolverElements[mt.HA_PANEL_LOVELACE].element.then((function(i) {
...
const Ka = new Tc();
let pr = {};
Ka.addEventListener("onLovelacePanelLoad", ({ detail: t }) => {
  t.HUI_ROOT.element.then((e) => {
    const n = e == null ? void 0 : e.lovelace;
    n != null && n.config && (pr = n.config["expander-card"] || {});
  }).catch(() => {
    pr = {};
  }).finally(() => {
...
var Cc = /* @__PURE__ */ st("<ha-ripple></ha-ripple>", 2), Rc = /* @__PURE__ */ st('<button aria-label="Toggle button"><ha-icon></ha-icon> <!></button>', 2), Ic = /* @__PURE__ */ st("<ha-ripple></ha-ripple>", 2), Lc = /* @__PURE__ */ st('<div id="id1"><div id="id2"><!></div> <!> <!></div>'), kc = /* @__PURE__ */ st("<button><div> </div> <ha-icon></ha-icon> <ha-ripple></ha-ripple></button>", 2), Pc = /* @__PURE__ */ st("<div><div></div></div>"), Dc = /* @__PURE__ */ st("<ha-card><!> <!> <!></ha-card>", 2);
const Mc = {
  hash: "svelte-1jqiztq",
...
function Hc(t, e) {
  Oi(e, !0), ja(t, Mc);
  const n = Ne(e, "hass"), i = Ne(e, "preview"), r = Ne(e, "config", 7, bi);
  let s = /* @__PURE__ */ M(!1), a = /* @__PURE__ */ M(null), o = /* @__PURE__ */ M(Xe(!!Re(() => i()))), l = /* @__PURE__ */ M(Xe(!!Re(() => i()))), u = /* @__PURE__ */ M(!0), c = /* @__PURE__ */ M("idle"), f = /* @__PURE__ */ M(null), _ = /* @__PURE__ */ M(0), w = /* @__PURE__ */ M(0), y = /* @__PURE__ */ M(null), A = /* @__PURE__ */ M(null), d = /* @__PURE__ */ M(null), v = /* @__PURE__ */ M(null);
  const g = {}, m = {}, S = {}, x = /* @__PURE__ */ M(Xe({}));
  let C = /* @__PURE__ */ M(Xe(Nc()));
  const k = /* @__PURE__ */ Cn(() => h(x).style !== void 0 ? `<style>${String(h(x).style)}</style>` : r().style ? `<style>${r().style}</style>` : null), F = /* @__PURE__ */ Cn(() => h(x).icon !== void 0 ? String(h(x).icon) : r().icon), H = /* @__PURE__ */ Cn(() => h(x).title !== void 0 ? String(h(x).title) : r().title), tr = /* @__PURE__ */ Cn(() => h(x)["arrow-color"] !== void 0 ? String(h(x)["arrow-color"]) : r()["arrow-color"]), On = Re(() => r()["storage-id"]), Gi = "expander-open-" + On;
  O(u, Re(() => i() || (qr(r()["show-button-users"]) ?? !0)), !0), dn(() => {
    if (h(x).expanded === void 0 || Re(() => i() && h(C)["preview-expanded"] !== !1))
      return;
    const b = !!h(x).expanded;
    queueMicrotask(() => {
      b !== h(o) && Tt(b);
    });
  }), dn(() => {
    if (!(i() === h(l) || i() === void 0)) {
      ...
      if (O(u, qr(r()["show-button-users"]) ?? !0, !0), nr("expanded")) {
        const b = Re(() => h(x).expanded);
        b !== void 0 && Tt(!!b);
        return;
      }
      zi();
  ...
  function zi() {
    if (!nr("expanded")) {
      ...
      try {
        const b = localStorage.getItem(Gi);
        if (b === null) {
          Bi();
          return;
        }
  ...
  function Tt(b) {
    ...
    if (Fr(E), O(c, E ? "opening" : "closing", !0), E) {
      Sn(!0), O(
        f,
        setTimeout(
          () => {
  ...
  function Sn(b) {
    if (O(o, b, !0), !i() && On !== void 0)
      try {
        localStorage.setItem(Gi, h(o) ? "true" : "false");
      } catch (E) {
        console.error(E);
      }
    h(o) && h(_) === 0 && O(_, 0.35);
  ...
  function ro() {
    document.body.removeEventListener("ll-custom", Wi), document.body.removeEventListener("expander-card-raw-config-updated", Vi), Object.entries(S).forEach(([b, E]) => {
      E.then(($) => {
        $(), delete S[b];
      }).catch(() => {
      });
  ...
  const Yi = (b) => {
    r().haptic && r().haptic !== "none" && cc(b, r().haptic);
  };
  let xn, Tn = !1, Ji = 0, Ki = 0;
  const io = (b) => {
    h(v) && (h(v).disabled = !0), xn = b.target, Ji = b.touches[0].clientX, Ki = b.touches[0].clientY, Tn = !1;
  }, so = (b) => {
    const E = b.touches[0].clientX, $ = b.touches[0].clientY;
    Tn = Math.abs(E - Ji) > 10 || Math.abs($ - Ki) > 10;
  }, ao = () => {
    h(v) && (h(v).disabled = !1), xn = void 0, Tn = !1;
  }, oo = () => {
    h(v) && (h(v).disabled = !1);
  }, lo = (b) => {
    !Tn && xn === b.target && r()["title-card-clickable"] && (Yi(xn), Tt(), O(s, !0), O(
      a,
      window.setTimeout(
        () => {
          O(s, !1), O(a, null);
    ...
    for (const E of Object.values(r().variables ?? {}))
      hr(E.value_template) ? m[E.variable] = _s(
        b,
        ($) => {
          gs(b, E.variable, $);
        },
        E.value_template,
        { config: r() }
      ) : gs(b, E.variable, E.value_template);
  }, uo = (b) => {
    g["expander-card"] = _c(b, "expander-card");
  }, fo = () => {
    if (!r().templates) return;
    const b = Object.values(r().variables || {}).reduce(
      ($, W) => ($[W.variable] = void 0, $),
      {}
    ), E = pc({ config: r(), expanderCard: {} }, b);
    co(E), uo(E), Object.values(r().templates || {}).forEach(($) => {
      hr($.value_template) ? S[$.template] = _s(
        E,
        (W) => {
          h(x)[$.template] = W;
        },
  ...
  Ha(() => {
    fo(), Fr(!1), ho(), po(), document.body.addEventListener("ll-custom", Wi), document.body.addEventListener("expander-card-raw-config-updated", Vi);
    const b = vo();
    return b && (b.addEventListener("touchstart", io, { passive: !0, capture: !0 }), b.addEventListener("touchmove", so, { passive: !0, capture: !0 }), b.addEventListener("touchcancel", ao, { passive: !0, capture: !0 }), b.addEventListener("touchend", oo, { passive: !0, capture: !0 }), b.addEventListener("touchend", lo, { passive: !1, capture: !1 })), r()["title-card-clickable"] && r()["title-card-button-overlay"] && h(A) && new ResizeObserver(() => {
      if (h(d) && h(A) && h(y)) {
        const $ = h(A).getBoundingClientRect();
        O(w, $.height - parseFloat(getComputedStyle(h(d)).marginTop) - parseFloat(getComputedStyle(h(d)).marginBottom) + parseFloat(getComputedStyle(h(y)).paddingTop) + parseFloat(getComputedStyle(h(y)).paddingBottom));
      }
    }).observe(h(A)), ro;
  });
  const Ur = (b) => {
    if (!h(s)) {
      Yi(b.currentTarget), Tt();
      return;
    }
    return b.preventDefault(), b.stopImmediatePropagation(), O(s, !1), h(a) && (clearTimeout(h(a)), O(a, null)), !1;
  };
  var _o = {
    get hass() {
      return n();
  ...
  }, en = Dc(), Qi = ct(en);
  {
    var go = (b) => {
      ...
      E.__click = function(...X) {
        var te;
        (te = r()["title-card-clickable"] && !r()["title-card-button-overlay"] ? Ur : null) == null || te.apply(this, X);
      };
      var $ = ct(E), W = ct($);
      gi(W, {
        get hass() {
      ...
      var Oe = Ct($, 2);
      {
        var Se = (X) => {
          ...
          te.__click = function(...Nt) {
            var Nn;
            (Nn = !r()["title-card-clickable"] || r()["title-card-button-overlay"] ? Ur : null) == null || Nn.apply(this, Nt);
          };
          var He = ct(te);
          We(() => ds(He, "icon", h(F)));
          var Eo = Ct(He, 2);
          {
            var $o = (Nt) => {
              var Nn = Cc();
              ft(Nn, (Ao) => O(v, Ao), () => h(v)), ve(Nt, Nn);
            };
            ut(Eo, (Nt) => {
              (!r()["title-card-clickable"] || r()["title-card-button-overlay"]) && Nt($o);
            });
          }
      ...
      var tn = Ct(Oe, 2);
      {
        ...
        ut(tn, (X) => {
          r()["title-card-clickable"] && !r()["title-card-button-overlay"] && X(Gr);
        });
      }
      Ve(E), ft(E, (X) => O(A, X), () => h(A)), We(() => {
        xe(E, 1, `title-card-header${r()["title-card-button-overlay"] ? "-overlay" : ""}${h(o) ? " open" : " close"}${r().animation ? " animation " + h(c) : ""}${r()["title-card-clickable"] ? " clickable" : ""}`, "svelte-1jqiztq"), Fa(E, "role", r()["title-card-clickable"] && !r()["title-card-button-overlay"] ? "button" : void 0), xe($, 1, `title-card-container${h(o) ? " open" : " close"}${r().animation ? " animation " + h(c) : ""}`, "svelte-1jqiztq"), dt($, `--title-padding:${(r()["title-card-padding"] ? r()["title-card-padding"] : "0px") ?? ""};`);
      }), ve(b, E);
    }, mo = (b) => {
      var E = cs(), $ = ss(E);
      {
        var W = (Oe) => {
          var Se = kc();
          Se.__click = Ur;
          var tn = ct(Se), Gr = ct(tn, !0);
          Ve(tn);
          var X = Ct(tn, 2);
          We(() => ds(X, "icon", h(F)));
          var te = Ct(X, 2);
          ft(te, (He) => O(v, He), () => h(v)), Ve(Se), ft(Se, (He) => O(d, He), () => h(d)), We(() => {
            xe(Se, 1, `header${h(o) ? " open" : " close"}${r().animation ? " animation " + h(c) : ""}`, "svelte-1jqiztq"), dt(Se, `--header-width:100%; --button-background:${r()["button-background"] ?? ""};--header-color:${r()["header-color"] ?? ""};`), xe(tn, 1, `primary title${h(o) ? " open" : " close"}`, "svelte-1jqiztq"), Ul(Gr, h(H)), dt(X, `--arrow-color:${h(tr) ?? ""}`), xe(X, 1, `ico${h(o) && h(c) !== "closing" ? " flipped open" : " close"}${r().animation ? " animation " + h(c) : ""}`, "svelte-1jqiztq");
          }), ve(Oe, Se);
        };
        ut($, (Oe) => {
          h(u) && Oe(W);
  ...
  return Ve(en), ft(en, (b) => O(y, b), () => h(y)), We(() => {
...
jl(["click"]);
customElements.define("expander-card", Ga(Hc, { hass: {}, preview: {}, config: {} }, [], [], !0, (t) => class extends t {
  constructor() {
    super(...arguments);
  ...
  static async getConfigElement() {
    return await qo(), document.createElement("expander-card-editor");
  }
 ...
 */
const vr = globalThis, Hi = vr.ShadowRoot && (vr.ShadyCSS === void 0 || vr.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ji = Symbol(), xs = /* @__PURE__ */ new WeakMap();
let Qa = class {
  constructor(e, n, i) {
  ...
  get styleSheet() {
    ...
    if (Hi && e === void 0) {
      ...
      i && (e = xs.get(n)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && xs.set(n, e));
    }
    return e;
  }
  toString() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Uc, defineProperty: Gc, getOwnPropertyDescriptor: zc, getOwnPropertyNames: Bc, getOwnPropertySymbols: Vc, getPrototypeOf: Wc } = Object, $t = globalThis, Ns = $t.trustedTypes, Yc = Ns ? Ns.emptyScript : "", ei = $t.reactiveElementPolyfillSupport, Hn = (t, e) => t, Sr = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Yc : null;
      break;
  ...
  return n;
} }, qi = (t, e) => !Uc(t, e), Cs = { attribute: !0, type: String, converter: Sr, reflect: !1, useDefault: !1, hasChanged: qi };
...
let on = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Hn("properties"))) {
      const n = this.properties, i = [...Bc(n), ...Vc(n)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const r of i) n.unshift(Ts(r));
    } else e !== void 0 && n.push(Ts(e));
    return n;
  }
  static _$Eu(e, n) {
    const i = n.attribute;
  ...
  createRenderRoot() {
    ...
    return qc(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
    var e;
  ...
  _$ET(e, n) {
    ...
    if (r !== void 0 && i.reflect === !0) {
      const a = (((s = i.converter) == null ? void 0 : s.toAttribute) !== void 0 ? i.converter : Sr).toAttribute(n, i.type);
  ...
  _$AK(e, n) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const o = i.getPropertyOptions(r), l = typeof o.converter == "function" ? { fromAttribute: o.converter } : ((s = o.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? o.converter : Sr;
      this._$Em = r;
  ...
  requestUpdate(e, n, i, r = !1, s) {
    ...
    if (e !== void 0) {
      ...
      if (r === !1 && (s = this[e]), i ?? (i = o.getPropertyOptions(e)), !((i.hasChanged ?? qi)(s, n) || i.useDefault && i.reflect && s === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(o._$Eu(e, i)))) return;
      this.C(e, n, i);
    }
...
on.elementStyles = [], on.shadowRootOptions = { mode: "open" }, on[Hn("elementProperties")] = /* @__PURE__ */ new Map(), on[Hn("finalized")] = /* @__PURE__ */ new Map(), ei == null || ei({ ReactiveElement: on }), ($t.reactiveElementVersions ?? ($t.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const jn = globalThis, Rs = (t) => t, xr = jn.trustedTypes, Is = xr ? xr.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Xa = "$lit$", pt = `lit$${Math.random().toFixed(9).slice(2)}$`, Za = "?" + pt, Jc = `<${Za}>`, Jt = document, Gn = () => Jt.createComment(""), zn = (t) => t === null || typeof t != "object" && typeof t != "function", Ui = Array.isArray, Kc = (t) => Ui(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", ti = `[ 	
\f\r]`, In = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ls = /-->/g, ks = />/g, It = RegExp(`>|${ti}(?:([^\\s"'>=/]+)(${ti}*=${ti}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ps = /'/g, Ds = /"/g, eo = /^(?:script|style|textarea|title)$/i, Qc = (t) => (e, ...n) => ({ _$litType$: t, strings: e, values: n }), an = Qc(1), $n = Symbol.for("lit-noChange"), U = Symbol.for("lit-nothing"), Ms = /* @__PURE__ */ new WeakMap(), kt = Jt.createTreeWalker(Jt, 129);
function to(t, e) {
  if (!Ui(t) || !t.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Is !== void 0 ? Is.createHTML(e) : e;
}
const Xc = (t, e) => {
  ...
  for (let o = 0; o < n; o++) {
    const l = t[o];
    let u, c, f = -1, _ = 0;
    for (; _ < l.length && (a.lastIndex = _, c = a.exec(l), c !== null); ) _ = a.lastIndex, a === In ? c[1] === "!--" ? a = Ls : c[1] !== void 0 ? a = ks : c[2] !== void 0 ? (eo.test(c[2]) && (r = RegExp("</" + c[2], "g")), a = It) : c[3] !== void 0 && (a = It) : a === It ? c[0] === ">" ? (a = r ?? In, f = -1) : c[1] === void 0 ? f = -2 : (f = a.lastIndex - c[2].length, u = c[1], a = c[3] === void 0 ? It : c[3] === '"' ? Ds : Ps) : a === Ds || a === Ps ? a = It : a === Ls || a === ks ? a = In : (a = It, r = void 0);
    const w = a === It && t[o + 1].startsWith("/>") ? " " : "";
    s += a === In ? l + Jc : f >= 0 ? (i.push(u), l.slice(0, f) + Xa + l.slice(f) + pt + w) : l + pt + (f === -2 ? o : w);
  }
  return [to(t, s + (t[n] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class Bn {
  constructor({ strings: e, _$litType$: n }, i) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const o = e.length - 1, l = this.parts, [u, c] = Xc(e, n);
    ...
    for (; (r = kt.nextNode()) !== null && l.length < o; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const f of r.getAttributeNames()) if (f.endsWith(Xa)) {
          const _ = c[a++], w = r.getAttribute(f).split(pt), y = /([.?@])?(.*)/.exec(_);
          l.push({ type: 1, index: s, name: y[2], strings: w, ctor: y[1] === "." ? eu : y[1] === "?" ? tu : y[1] === "@" ? nu : Hr }), r.removeAttribute(f);
        ...
        if (eo.test(r.tagName)) {
          ...
          if (_ > 0) {
            r.textContent = xr ? xr.emptyScript : "";
            for (let w = 0; w < _; w++) r.append(f[w], Gn()), kt.nextNode(), l.push({ type: 2, index: ++s });
            r.append(f[_], Gn());
          }
        }
      } else if (r.nodeType === 8) if (r.data === Za) l.push({ type: 2, index: s });
      else {
        let f = -1;
...
class Zc {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let u;
        l.type === 2 ? u = new Zn(s, s.nextSibling, this, e) : l.type === 1 ? u = new l.ctor(s, l.name, l.strings, this, e) : l.type === 6 && (u = new ru(s, this, e)), this._$AV.push(u), l = i[++o];
      }
...
class Zn {
  ...
  _$AI(e, n = this) {
    e = An(this, e, n), zn(e) ? e === U || e == null || e === "" ? (this._$AH !== U && this._$AR(), this._$AH = U) : e !== this._$AH && e !== $n && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Kc(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var s;
    const { values: n, _$litType$: i } = e, r = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = Bn.createElement(to(i.h, i.h[0]), this.options)), i);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === r) this._$AH.p(n);
    else {
      const a = new Zc(r, this), o = a.u(this.options);
      a.p(n), this.T(o), this._$AH = a;
    }
  }
  _$AC(e) {
    let n = Ms.get(e.strings);
    return n === void 0 && Ms.set(e.strings, n = new Bn(e)), n;
  }
  k(e) {
...
ni == null || ni(Bn, Zn), (jn.litHtmlVersions ?? (jn.litHtmlVersions = [])).push("3.3.2");
const iu = (t, e, n) => {
...
class Fn extends on {
  ...
  update(e) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = iu(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var js;
Fn._$litElement$ = !0, Fn.finalized = !0, (js = zt.litElementHydrateSupport) == null || js.call(zt, { LitElement: Fn });
const ri = zt.litElementPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const au = { attribute: !0, type: String, converter: Sr, reflect: !1, hasChanged: qi }, ou = (t = au, e, n) => {
...
function jr(t) {
  return (e, n) => typeof n == "object" ? ou(t, e, n) : ((i, r, s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lu = (t, e, n) => (n.configurable = !0, n.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(t, e, n), n);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;
var hu = Object.defineProperty, pu = Object.getOwnPropertyDescriptor, Be = (t, e, n, i) => {
  for (var r = i > 1 ? void 0 : i ? pu(e, n) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (r = (i ? a(e, n, r) : a(r)) || r);
  return i && r && hu(e, n, r), r;
};
const no = "custom:", vu = (t) => t.startsWith(no), _u = (t) => {
  var e;
...
let he = class extends Fn {
  ...
  render() {
    ...
    if (this._config.type) {
      let i;
      vu(this._config.type) ? (i = (n = _u(
        gu(this._config.type)
...
Be([
  cu("hui-card-element-editor")
], he.prototype, "_cardEditorEl", 2);
he = Be([
  su("expander-card-title-card-edit-form")
], he);
console.info(
  `%c  Expander-Card 
%c Version ${jc}`,
