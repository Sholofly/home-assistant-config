# custom_components/googlefindmy/Auth/firebase_messaging/proto/checkin_pb2.py
...
# Use the same descriptor pool as android_checkin_pb2 to resolve dependencies
try:
    from . import android_checkin_pb2
    _firebase_pool = android_checkin_pb2._firebase_pool
except ImportError:
